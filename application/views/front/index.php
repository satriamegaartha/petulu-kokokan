...
<head>
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="<?= base_url('assets_front/'); ?>css/base.css">
    <link rel="stylesheet" href="<?= base_url('assets_front/'); ?>css/vendor.css">
    ...
    <link rel="icon" href="<?= base_url('assets_front/'); ?>favicon.png" type="image/x-icon">
...
<body id="top">
    ...
    <!-- home
    ================================================== -->
    <section id="home" class="s-home page-hero target-section" data-parallax="scroll" data-image-src="<?= base_url('assets_front/'); ?>images/hero-bg.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
    ...
    <!-- services
    ================================================== -->
    <section id="services" class="s-services target-section mx-auto" style="background: url(<?= base_url('assets_front/'); ?>images/portfolio/gallery/g-lamp.jpg);">
        ...
        <div class="portfolio block-1-4 block-m-1-3 block-tab-1-2 collapse">
            ...
            <div class="col-block item-folio" data-aos="fade-up">
                ...
                <div class="item-folio__thumb">
                    <a href="<?= base_url('assets_front/'); ?>images/portfolio/gallery/g-lamp.jpg" class="thumb-link" title="Lamp" data-size="1050x700">
                        <img src="<?= base_url('assets_front/'); ?>images/portfolio/lamp.jpg" srcset="<?= base_url('assets_front/'); ?>images/portfolio/lamp.jpg 1x, images/portfolio/lamp@2x.jpg 2x" alt="">
                    </a>
                </div>
            ...
            <div class="col-block item-folio" data-aos="fade-up">
                ...
                <div class="item-folio__thumb">
                    <a href="<?= base_url('assets_front/'); ?>images/portfolio/gallery/g-fuji.jpg" class="thumb-link" title="Fuji" data-size="1050x700">
                        <img src="<?= base_url('assets_front/'); ?>images/portfolio/fuji.jpg" srcset="<?= base_url('assets_front/'); ?>images/portfolio/fuji.jpg 1x, images/portfolio/fuji@2x.jpg 2x" alt="">
                    </a>
                </div>
            ...
            <div class="col-block item-folio" data-aos="fade-up">
                ...
                <div class="item-folio__thumb">
                    <a href="<?= base_url('assets_front/'); ?>images/portfolio/gallery/g-woodcraft.jpg" class="thumb-link" title="Woodcraft" data-size="1050x700">
                        <img src="<?= base_url('assets_front/'); ?>images/portfolio/woodcraft.jpg" srcset="<?= base_url('assets_front/'); ?>images/portfolio/woodcraft.jpg 1x, images/portfolio/woodcraft@2x.jpg 2x" alt="">
                    </a>
                </div>
            ...
            <div class="col-block item-folio" data-aos="fade-up">
                ...
                <div class="item-folio__thumb">
                    <a href="<?= base_url('assets_front/'); ?>images/portfolio/gallery/g-droplet.jpg" class="thumb-link" title="Droplet" data-size="1050x700">
                        <img src="<?= base_url('assets_front/'); ?>images/portfolio/droplet.jpg" srcset="<?= base_url('assets_front/'); ?>images/portfolio/droplet.jpg 1x, images/portfolio/droplet@2x.jpg 2x" alt="">
                    </a>
                </div>
            ...
            <div class="col-block item-folio" data-aos="fade-up">
                ...
                <div class="item-folio__thumb">
                    <a href="<?= base_url('assets_front/'); ?>images/portfolio/gallery/g-shutterbug.jpg" class="thumb-link" title="Shutterbug" data-size="1050x700">
                        <img src="<?= base_url('assets_front/'); ?>images/portfolio/shutterbug.jpg" srcset="<?= base_url('assets_front/'); ?>images/portfolio/shutterbug.jpg 1x, images/portfolio/shutterbug@2x.jpg 2x" alt="">
                    </a>
                </div>
            ...
            <div class="col-block item-folio" data-aos="fade-up">
                ...
                <div class="item-folio__thumb">
                    <a href="<?= base_url('assets_front/'); ?>images/portfolio/gallery/g-minimalismo.jpg" class="thumb-link" title="Minimalismo" data-size="1050x700">
                        <img src="<?= base_url('assets_front/'); ?>images/portfolio/minimalismo.jpg" srcset="<?= base_url('assets_front/'); ?>images/portfolio/minimalismo.jpg 1x, images/portfolio/minimalismo@2x.jpg 2x" alt="">
                    </a>
                </div>
            ...
            <div class="col-block item-folio" data-aos="fade-up">
                ...
                <div class="item-folio__thumb">
                    <a href="<?= base_url('assets_front/'); ?>images/portfolio/gallery/g-film.jpg" class="thumb-link" title="Film" data-size="1050x700">
                        <img src="<?= base_url('assets_front/'); ?>images/portfolio/film.jpg" srcset="<?= base_url('assets_front/'); ?>images/portfolio/film.jpg 1x, images/portfolio/film@2x.jpg 2x" alt="">
                    </a>
                </div>
            ...
            <div class="col-block item-folio" data-aos="fade-up">
                ...
                <div class="item-folio__thumb">
                    <a href="<?= base_url('assets_front/'); ?>images/portfolio/gallery/g-skaterboy.jpg" class="thumb-link" title="Skaterboy" data-size="1050x700">
                        <img src="<?= base_url('assets_front/'); ?>images/portfolio/skaterboy.jpg" srcset="<?= base_url('assets_front/'); ?>images/portfolio/skaterboy.jpg 1x, images/portfolio/skaterboy@2x.jpg 2x" alt="">
                    </a>
                </div>
                ...
                <div class="col-full testimonials__slider">
                    ...
                    <div class="testimonials__slide">
                        ...
                        <div class="testimonials__author">
                            <img src="<?= base_url('assets_front/'); ?>images/avatars/user-01.jpg" alt="Author image" class="testimonials__avatar">
                    ...
                    <div class="testimonials__slide">
                        ...
                        <div class="testimonials__author">
                            <img src="<?= base_url('assets_front/'); ?>images/avatars/user-05.jpg" alt="Author image" class="testimonials__avatar">
                    ...
                    <div class="testimonials__slide">
                        ...
                        <div class="testimonials__author">
                            <img src="<?= base_url('assets_front/'); ?>images/avatars/user-02.jpg" alt="Author image" class="testimonials__avatar">
    ...
    <section id="clients" class="s-clients target-section">
        ...
        <div class="row clients-list block-1-4 block-tab-1-3 block-mob-1-2" data-aos="fade-up">
            ...
            <div class="col-block item-client">
                <a href="#0">
                    <img src="<?= base_url('assets_front/'); ?>images/clients/icon-atom.svg" alt="">
                </a>
            </div>
            <div class="col-block item-client">
                <a href="#0">
                    <img src="<?= base_url('assets_front/'); ?>images/clients/icon-dropbox.svg" alt="">
                </a>
            </div>
            <div class="col-block item-client">
                <a href="#0">
                    <img src="<?= base_url('assets_front/'); ?>images/clients/icon-firefox.svg" alt="">
                </a>
            </div>
            <div class="col-block item-client">
                <a href="#0">
                    <img src="<?= base_url('assets_front/'); ?>images/clients/icon-github.svg" alt="">
                </a>
            </div>
            <div class="col-block item-client">
                <a href="#0">
                    <img src="<?= base_url('assets_front/'); ?>images/clients/icon-mozilla.svg" alt="">
                </a>
            </div>
            <div class="col-block item-client">
                <a href="#0">
                    <img src="<?= base_url('assets_front/'); ?>images/clients/icon-linux.svg" alt="">
                </a>
            </div>
            <div class="col-block item-client">
                <a href="#0">
                    <img src="<?= base_url('assets_front/'); ?>images/clients/icon-ubuntu.svg" alt="">
                </a>
            </div>
            <div class="col-block item-client">
                <a href="#0">
                    <img src="<?= base_url('assets_front/'); ?>images/clients/icon-sass.svg" alt="">
                </a>
            </div>
