        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <div class="col">
                        <?php echo form_open_multipart('user/galeridesa/') ?>
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <a href=" <?= base_url('user/galeridesaadd/') ?>" class="btn btn-sm btn-primary float-right">Tambah Data</a>
                                </div>
                            </div>
                        </div>
                        </form>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($galeri_desa as $g) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href=" <?= base_url('user/galeridesaedit/') . $g['id'] ?>" class="btn btn-sm btn-warning">Edit</a>
                                        <a href="<?= base_url('user/galeridesadelete/') . $g['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Data akan dihapus?')">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
